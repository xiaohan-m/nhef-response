...
if __name__ == '__main__':
    ...
    df1 = pandas.read_excel(r'../../错误转发路径/自然丢包率/数据统计_lossRate_0.0001_2022_0821_2235.xlsx')
    data1 = np.array(df1)

    df2 = pandas.read_excel(r'../../错误转发路径/自然丢包率/数据统计_lossRate_0.0005_2022_0821_2234.xlsx')
    data2 = np.array(df2)

    df3 = pandas.read_excel(r'../../错误转发路径/自然丢包率/数据统计_lossRate_0.001_2022_0821_2233.xlsx')
    data3 = np.array(df3)
