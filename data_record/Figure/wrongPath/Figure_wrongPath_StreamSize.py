...
if __name__ == '__main__':
    ...
    df2 = pandas.read_excel(r'../../错误转发路径/流中包的数量/数据统计_streamSize_50_2022_0826_0000.xlsx')
    data2 = np.array(df2)

    df3 = pandas.read_excel(r'../../错误转发路径/流中包的数量/数据统计_streamSize_100_2022_0826_0220.xlsx')
    data3 = np.array(df3)
