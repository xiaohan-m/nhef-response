...
if __name__ == '__main__':
    ...
    df1 = pandas.read_excel(r'../../错误转发路径/流中包的数量/数据统计_streamSize_5_2022_0821_2027.xlsx')
    data1 = np.array(df1)

    df2 = pandas.read_excel(r'../../错误转发路径/流中包的数量/数据统计_streamSize_10_2022_0821_2230.xlsx')
    data2 = np.array(df2)

    df3 = pandas.read_excel(r'../../错误转发路径/流中包的数量/数据统计_streamSize_20_2022_0821_2334.xlsx')
    data3 = np.array(df3)
